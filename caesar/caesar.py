...
Caesar automatic cracker - Brute force
"""

ciphertext = "vwduwljudeehghyhubwklqjlfrxogilqgsohdvhuhwxuqdqbeoxhsulqwviruydxowdqgdodupghvljqedvhgrqzklfkedqnbrxghflghrqldpvhwwlqjxsvdihkrxvhfr".upper().replace(" ", "").replace("\n", "")
...
print("Key:", best_decryption["shift_letter"])
print(best_decryption["text"])
